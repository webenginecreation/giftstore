     ...
     <div class="row">
            <div class="col-12">
                <div class="heading_s1">
                    <h2 style="font-family: 'Lobster', cursive !important;">Our Awesome Varities</h2>
                </div>
    	...
    	<div class="row">
        	<div class="col-md-6">
            	<div class="single_banner">
                	<img data-src="<?php echo e(url('Users_assets')); ?>/assets/images/The-shoes-you-need-for-spring.jpg" class="lazyload rounds" alt="shop_banner_img1"/>
                    <div class="single_banner_info">
                        <h5 class="single_bn_title1">Super Sale</h5>
                        <h3 class="single_bn_title">Gifts For Her</h3>
            ...
            <div class="col-md-6">
            	<div class="single_banner">
                	<img data-src="<?php echo e(url('Users_assets')); ?>/assets/images/Raver-Wearing-embroidered-dress.jpg" alt="shop_banner_img2" class="lazyload rounds"/>
                    <div class="single_banner_info">
                        <h3 class="single_bn_title">New Season</h3>
                        <h4 class="single_bn_title1">Gifts For Him</h4>
                        <a href="" class="single_bn_link">Shop Now</a>
                    </div>
                </div>
            </div>
...
<div class="section offer_slider">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="heading_s1" >
                    <h2 style="font-family: 'Lobster', cursive !important;"><?php echo e($index); ?></h2>
                </div>
            </div>
        </div>
        <div class="row">
    	...
    	<div class="row align-items-center flex-row-reverse">
            ...
            <div class="col-md-5">
                <div class="text-center trading_img">
                    <img data-src="<?php echo e(url('Users_assets')); ?>/assets/images/details.jpg" class="lazyload" alt="tranding_img"/>
                </div>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('user.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u980489449/domains/happiness.gifts/public_html/resources/views/user/index.blade.php ENDPATH**/ ?>