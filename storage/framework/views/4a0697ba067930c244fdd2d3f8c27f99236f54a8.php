                                    ...
                                    <form method="POST" id="adminSiteConfigValidation" enctype="multipart/form-data" action="<?php echo e(route('update.site.config',["id" => $site_config->id])); ?>" > <?php echo csrf_field(); ?>     
                                        ...
                                        <div class="row">
                                          ...
                                          <div class="col-lg-6">
                                            ...
                                            <img src="<?php echo e(url('images')); ?>/<?php echo e($site_config->logo); ?>">
                                       ...
                                       <div class="col-md-6">
                                            ...
                                            <input type="text" id="instagram"  value="<?php echo e($site_config->instagram); ?>" class="form-control" name="instagram">
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <textarea class="form-control" id="address_2" name="address_2" rows="4"> <?php echo e($site_config->address_2); ?>  </textarea>
                                            </div>
                                             <div class="form-group">
                                            <label for="simpleFormEmail">city</label>
                                            <input type="text" id="city"  value="<?php echo e($site_config->city); ?>" class="form-control" name="city">
                                            </div>
                                             <div class="form-group">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('Admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u980489449/domains/happiness.gifts/public_html/resources/views/Admin/site_config.blade.php ENDPATH**/ ?>