                ...
                <div class="row">
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="blog_post blog_style2 box_shadow1">
                            <div class="blog_img">
                                <a href="<?php echo e(route('blog.details',["slug" => $value->blog_slug])); ?>">
                            ...
                            <div class="blog_content bg-white">
                                <div class="blog_text">
                                    ...
                                    <ul class="list_none blog_meta">
                                        ...
                                        <a style="color:blue" href="<?php echo e(route('blog.details',["slug" => $value->blog_slug])); ?>">CLICK HERE...</a>
                                </div>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('user.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Shopping\resources\views/user/blogs/index.blade.php ENDPATH**/ ?>