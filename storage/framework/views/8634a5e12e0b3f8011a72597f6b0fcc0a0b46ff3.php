...
<html lang="en">
<head>
    <title><?php echo $__env->yieldContent('title','Happiness.gifts | Spread your feelings with personalized gifts with us.'); ?></title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="keywords" content="<?php echo $__env->yieldContent('meta_keywords','Ecommerce,Shopping,affiliate,shopify'); ?>">
    <meta name="description" content="<?php echo $__env->yieldContent('meta_description','Larastore.ml a rapid solution of ecommerce, there have fully ecommerce features'); ?>">
...
<a href="https://api.whatsapp.com/send?phone=918460078163&text=Hello We are trying to Reach you." class="float" target="_blank">
...
</html><?php /**PATH /home/u980489449/domains/happiness.gifts/public_html/resources/views/user/master.blade.php ENDPATH**/ ?>