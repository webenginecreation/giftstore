	                    ...
	                    <ul class="sidemenu  page-header-fixed sidemenu-hover-submenu" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px">
	                        <li class="sidebar-toggler-wrapper hide">
	                          ...
	                          <li class="sidebar-user-panel">
	                            <div class="user-panel">
	                                <div class="">
	                                   <img src="{{url('images')}}/{{$siteConfig->logo}}">
	                                </div>
	                        ...
	                        <li class="nav-item ">
	                            ...
	                            <ul class="sub-menu">
	                                ...
	                                <li class="nav-item ">
	                                    <a href="{{ route('customize.template') }}" class="nav-link ">
                           ...
                           <li class="nav-item start">
	                        ...
	                        <li class="nav-item start">
	                            ...
	                            <ul class="sub-menu">
	                                ...
	                                <li class="nav-item ">
	                                    <a href="{{ route('today-orders') }}" class="nav-link ">
	                       ...
	                       <li class="nav-item start">
	                            ...
	                            <ul class="sub-menu">
	                                ...
	                                <li class="nav-item ">
	                                    <a href="{{route('create.offers')}}" class="nav-link ">
	                                ...
	                                <li class="nav-item ">
	                                    <a href="{{route('offers.products')}}" class="nav-link ">
	                        ...
	                        <li class="nav-item ">
	                                ...
	                                <li class="nav-item ">
	                                    <a href="{{ route('dailyCollection') }}" class="nav-link ">
	                                        <span class="title">Daily Report</span>
	                                        <span class="selected"></span>
	                                    </a>
	                                </li>
	                            	<li class="nav-item ">
	                                    <a href="{{ route('datewiseReport') }}" class="nav-link ">
