...
<html lang="en">
<head>
    <title>@yield('title','Biztria.com | Lets Beauty With Us')</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="keywords" content="@yield('meta_keywords','Facewash,eyliner,beardo,laptops,shoes')">
    <meta name="description" content="@yield('meta_description','Love Beauty? Descover best beauty products & Fashion products, Beauty guide, information about products, Mens & Womens.')">
